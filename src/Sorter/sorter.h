...
private:
    ...
    std::vector<std::unique_ptr<TapeFile>> break_tape(TapeFile& m_input_tape, std::vector<std::string>& sub_tape_filenames);
    void merge_tapes(TapeFile& m_output_tape, std::vector<std::unique_ptr<TapeFile>>& sub_tapes);
